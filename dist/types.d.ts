...
export declare const BaseMessageTypes: {
    readonly PING: "PING";
    readonly PONG: "PONG";
...
export type MessageTarget = 'content' | 'background' | 'sidebar' | 'popup' | 'broadcast';
/**
...
export type MessageHandler<T, R> = (message: Message<T, R>) => Promise<R | void>;
